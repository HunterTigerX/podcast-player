...
let debounceFunction = function (func, delay, value) {
...
async function renderIdPage(id) {
    ...
    if (counter && grid) {
        ...
        preview.append(preview__image, preview__description__publisher, preview__description__channel_link, preview__description__ad, preview__description__prices, preview__description__button);
        ...
        podcast__description__wrapper.append(preview__description__title, preview__description__publisher_big, preview__description__rating, preview__description__text);
...
async function restoreAudioPlayer(url) {
...
function handleAudioTimeChange(timeChange) {
...
function switchAudioTrack(link) {
...
function saveLocalProgress(url, newProgress) {
...
function updateAudioProgress(url, newProgress) {
    const audioData = getAudioList();
    if (audioData) {
        const item = audioData.find((item) => item.url === url);
